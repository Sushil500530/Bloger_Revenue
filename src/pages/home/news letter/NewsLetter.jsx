...
const NewsLetter = () => {
    ...
    return (
        <div>
            <div className="bg-[url('https://i.ibb.co/ZfP2CF0/newsletter.png')] bg-cover bg-no-repeat object-cover flex items-center justify-between py-14 px-10 flex-col lg:flex-row w-full h-auto gap-10 my-12">
