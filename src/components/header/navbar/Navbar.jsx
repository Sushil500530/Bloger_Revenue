        ...
        <div className="drawer ">
            ...
            <div className="drawer-content flex flex-col relative">
                ...
                <div className="bg-[#f9fafc]">
                    <div className="navbar flex items-center justify-between container mx-auto">
                        ...
                        <div className="w-full md:w-auto lg:w-auto flex items-center justify-center gap-3 md:gap-4 lg:gap-4 font-medium">
                            <button className="uppercase">Login</button>
                            <button className="px-4 py-2 bg-green-600 uppercase rounded-full text-white">Sign Up</button>
                        </div>
                    </div>
                </div>
                {/* Page content here */}
