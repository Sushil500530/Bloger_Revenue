...
const Banner = () => {
    return (
        <div className="container mx-auto flex flex-col lg:flex-row items-start justify-center mt-12 gap-8 w-full h-auto px-5 pb-12">
            ...
            <div className="w-full h-full lg:w-1/2 mt-14">
                ...
                <div className="flex items-center gap-3 mt-[15%]">
                    ...
                    <div>
                        <h1 className="text-base font-bold">Sushil Hemrom</h1>
                        <p>April 02, 2024</p>
                    </div>
                </div>
            </div>
